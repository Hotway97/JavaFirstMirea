...
3. лРеализуйте простейший класс Book (Книга).
...
5. Создайте класс-тестер под названием TestDog - он реализует массив собак, основной метод этого класса позвояет добавить несколько объектов Dog.
